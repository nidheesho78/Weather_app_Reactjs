  ...
  return (
    <div className="app">
      ...
      <div className='container'>
        ...
        <div className='temp'>
        {data.main ? <h1>{toCelsius(data.main.temp)}°C</h1> : null}
      </div>
        ...
        <div className='bottom'>
         <div className='feels'>
        {data.main ? <p className='bold'>{toCelsius(data.main.feels_like)}°C</p> : null}
        <p>Feels Like</p>
      </div>
          ...
          <div className='wind'>
        {data.wind ? <p className='bold'>{toKPH(data.wind.speed)} KPH</p> : null}
        <p>Wind Speed</p>
      </div>
        </div>
        }
